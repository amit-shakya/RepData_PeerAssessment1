...
**This document has assignment #1 for the Coursera Reproducable Research class.**
...
Next,  read this data into a dataframe and inspect the structure of the data
```{r}
datam = read.csv('activity.csv', header = T)
names(datam)
str(datam)
head(datam)
```
...
Next, make a histogram of the total number of steps taken each day, but first  summarize the data by day:
```{r}
install.packages ("data.table")
library(data.table)
dat_tbl = data.table(datum)
...
**Next, visualize the daily activity pattern**
